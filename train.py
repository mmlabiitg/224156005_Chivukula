...
if __name__ == '__main__':
	...
	for epoch in range(start_epoch, opt.end_epoch + 1):
		...
		for i_batch, sample_batched in enumerate(dataloader):
			...
			depth_batch = sample_batched['depth']
			...
			opt.batch_G_loss = opt.batch_mse_loss
		...
		print('\nFinished ep. %d, lr = %.6f, total_mse = %.6f' % (epoch, get_lr(optim_g), opt.total_mse_loss))
